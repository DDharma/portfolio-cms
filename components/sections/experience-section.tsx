    ...
    <SectionShell id="experience">
      <SectionHeading
        ...
        description={
          ...
          'Key roles, achievements, and technical expertise across my career.'
        }
      />
      <div className="mt-12 space-y-4">
        {experience.map((item: any) => {
          ...
          return (
            <Card key={`${item.company}-${period}`} className="p-5 lg:p-6">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  ...
                  <p className="mt-4 text-sm text-zinc-400">{item.description || item.summary}</p>
                </div>
