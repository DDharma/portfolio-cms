...
import { useExperienceById } from '@/hooks/use-admin-api'
...
export default function EditExperiencePage() {
  ...
  const { data, isLoading, error } = useExperienceById(params.id as string)
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-zinc-400 mt-1">Update your experience details</p>
      </div>

      <ExperienceForm initialData={data || undefined} isLoading={isLoading} />
    </div>
  )
}
