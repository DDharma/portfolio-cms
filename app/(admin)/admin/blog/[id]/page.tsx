...
import { useBlogById } from '@/hooks/use-admin-api'
...
export default function EditBlogPage() {
  ...
  const { data, isLoading, error } = useBlogById(params.id as string)
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-zinc-400 mt-1">Update your blog post content</p>
      </div>

      <BlogForm initialData={data || undefined} isLoading={isLoading} />
    </div>
  )
}
