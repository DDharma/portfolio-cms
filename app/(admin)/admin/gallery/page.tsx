          ...
          <div className="flex items-center gap-2 border border-white/[0.1] rounded-lg p-1">
            <button
              ...
              className={`p-2 rounded transition-colors ${
                viewMode === 'grid' ? 'bg-white/[0.1] text-white' : 'text-zinc-400 hover:text-white'
              }`}
            >
                ...
                >
                  <div className="relative h-48 bg-zinc-900">
                    ...
                    <div className="absolute top-2 right-2 flex items-center gap-2 scale-0 group-hover:scale-100 transition-transform origin-top-right z-10">
                      <button
                        onClick={() =>
                          toggleFeatured.mutate({ id: photo.id, is_featured: !photo.is_featured })
                        }
            ...
            },
            {
              ...
              render: (_, item) => (
                <div className="flex items-center gap-2">
                  <button
                    onClick={() =>
                      toggleFeatured.mutate({ id: item.id, is_featured: !item.is_featured })
                    }
