...
export default function SkillsListPage() {
  ...
  const { data: sectionHeading, isLoading: isLoadingSectionHeading } = useSectionMetadata('skills')
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-400 mt-1">Manage your skill categories</p>
        </div>
        <Button onClick={() => router.push('/admin/skills/new')} className="gap-2">
      ...
      <DataTable
        ...
        data={data || []}
        loading={isLoading}
        emptyMessage="No skill categories created yet"
      />
    </div>
  )
}
