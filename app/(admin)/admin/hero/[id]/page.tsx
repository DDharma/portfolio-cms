...
import { useHeroById } from '@/hooks/use-admin-api'
...
export default function EditHeroPage() {
  ...
  const { data, isLoading, error } = useHeroById(params.id as string)
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-bold text-white">Edit Hero Section</h1>
