...
export const skillCategories: SkillCategory[] = [
  {
    ...
    description: 'Building modern, responsive user interfaces with clean component architecture.',
    icon: 'Sparkles',
  ...
  },
  {
    ...
    description: 'Reliable server-side services and API design.',
    icon: 'Server',
...
export const experienceTimeline: ExperienceItem[] = [
  {
    ...
    location: 'Remote',
    summary: 'Leading frontend architecture and building scalable web applications.',
    achievements: [
  ...
  },
  {
    ...
    location: 'Remote',
    summary: 'Built customer-facing dashboards and internal tools.',
    achievements: ['Developed admin dashboard from scratch', 'Improved page load times by 60%'],
